...
function customYear(firstDayOfWeek, week1IncludesYearsFirstWeekday, date) {
  ...
  // week 1 of the year is defined as the first full week that includes this weekday
 ...
 *
 * Returns a Number representing the count of whole `unit`s between `date1` and `date2`.
 *
 * @param {String} unit
 * @param {Date} date1
 * @param {Date} date2
 ...
 *
 * Returns an Array of Dates at every `step` number of `interval`s >= `date1` and < `date2`.
 *
 * @param {String} interval
